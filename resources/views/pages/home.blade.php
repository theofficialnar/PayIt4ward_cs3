...
@section('main_section')	
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<img src="{{ URL('assets/images/office1.jpeg') }}" alt="office1">
			...
			<div class="item">
			<img src="{{ URL('assets/images/office2.jpeg') }}" alt="office2">
				<div class="carousel-caption">
			...
			<div class="item">
			<img src="{{ URL('assets/images/office3.jpeg') }}" alt="office3">
				<div class="carousel-caption">
					<h3>Lounge Area</h3>
	...
	<div class="row">
		<div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
			<div class="well">
				...
				<hr>
				<img src="{{ URL('assets/images/news-photo.jpeg') }}" alt="cafe" class="img-responsive hcenter">
				...
				<div class="row">
					<div class="col-lg-7">
						<img src="{{ URL('assets/images/news-photo2.jpeg') }}" alt="desk" class="img-responsive hcenter">
					</div>
		...
		<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
			<div class="well col-lg-12">
				...
				<hr>
				<img src="{{ URL('assets/images/emp.jpg') }}" alt="emp" class="img-responsive emp_month text-center hcenter">
